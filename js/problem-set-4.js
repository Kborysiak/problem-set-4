...
function celsius() {
  ...
  var farenheit= ((cels * 9/5)+32).toFixed(2);
...
function inches() {
  ...
  var div5=document.getElementById("output5");
...
function centimeters() {
  ...
  var div6=document.getElementById("output6");
...
function fluidOunces() {
  ...
  var div7=document.getElementById("output7");
